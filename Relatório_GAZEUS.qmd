...
tabela_transactions <- tibble::tribble(
                         ...
                         "1", "2022-01-12", "255", "SUCCESS", "119.65",
...
tabela_transactions <- tbl(con, "tabela_transactions")
...
tabela_user <- datasets::mtcars

mean_tabela_use <- tabela_user %>%
                     dplyr::group_by(cyl) %>% 
                     dplyr::summarise(media_idade = mean(wt, na.rm = TRUE)) 

dplyr::show_query(mean_tabela_use)
